      ...
      <div className="card" style={{ maxWidth: 980, margin: "80px auto", padding: 28 }}>
        ...
        <div style={{ marginTop: 12, color: "rgba(255,255,255,0.92)", lineHeight: 1.5 }}>
          ...
          The movie posters and the movie statistics (such as critics score, popularity, etc) utilized on the website are courtesy of
            <a href="https://www.themoviedb.org/" target="_blank" style={{ color: "var(--redlink)", fontWeight: bold }}>TMDB</a>.</p>

          <p><strong>7. Contact Information:</strong><br />
            <a href="https://www.tiktok.com/@ricks_a_human" target="_blank" style={{ color: "var(--redlink)", fontWeight: bold; }}>@Ricks_a_human</a> on TikTok for management suppport.<br />
          Email: <a href="mailto:leaderbox_management@outlook.com" style={{ color: "var(--redlink)", fontWeight: bold }}>leaderbox_management@outlook.com</a> for legal or business porposes.</p>

          <p><strong>8. Support the website:
          Leaderbox is not a paid service! Any form of support is voluntary and could be done so via subscribing to Rick's a Human's <a href="https://www.youtube.com/@ricksahuman" target="_blank" style={{ color: "var(--redlink)", fontWeight: bold }}>Patreon </a>
            or <a href="https://www.youtube.com/@ricksahuman" target="_blank" style={{ color: "var(--redlink)", fontWeight: bold }}>Youtube!</a><br />
            Please also support <a className="small" href="https://www.youtube.com/@JangoDisc" target="_blank" rel="noreferrer" style={{color:"var(--redlink)", fontWeight: bold, marginLeft:8}}>JangoDisc </a>on Youtube, as his visual style was the inspiration for the website.</strong></p>
        </div>
      </div>
    </div>
  );
