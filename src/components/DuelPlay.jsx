...
export default function App() {
  ...
  // If the current path is the DuelPlay route, we want to hide the NavBar completely
  const hideNavForDuelPlay = location.pathname.startsWith("/duel/play");
  ...
  return (
    <div className="app-root">
      {/* Conditionally render NavBar: hidden on /duel/play routes so DuelPlay truly covers whole screen */}
      {!hideNavForDuelPlay && <NavBar user={user} onOpenProfile={() => setModalOpen(true)} />}
      ...
      <div className="app-container">
        <Routes>
          ...
          {/* DuelPlay route — when this is active NavBar is hidden (see above) so the page is fully covered */}
